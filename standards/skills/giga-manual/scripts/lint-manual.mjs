...
export function lintManual(md) {
  ...
  /* 見出しの中のルビについて、ここには 2026-08-30 まで警告があった。
     目次と検索の索引が <rt> の中身まで拾い、「学年」が「学がく年ねん」に
     なっていたためである。だが目次は、漢字が読めない子がいちばん最初に
     見るところで、そこだけルビを諦めるのは順序が逆だった。
     組み立ての側（tools/lib/plain-text.mjs）を直したので、警告は外した。
     見出しにもルビを振ってよい。 */
